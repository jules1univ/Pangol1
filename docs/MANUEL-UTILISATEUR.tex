...
\begin{enumerate}
    \item Lancez le fichier \textbf{Pangol1.jar} ou exécutez la commande : \texttt{java -jar Pangol1.jar} ou compiler le programme depuis vscode ./pangol1/src/application/Pangol1.java
...
\begin{enumerate}
    \item Lancez Pangol1
    \item Allez dans \textbf{File} → \textbf{Open} pour charger un fichier ( CSV , txt, TSV, ZIP, Parquet )
    \item Sélectionnez un fichier sur votre ordinateur
    \item Les données s'affichent automatiquement dans la table à droite
    \item Configurez votre graphique via le panneau de configuration en bas à gauche
\end{enumerate}
...
\begin{itemize}
    \item \textbf{Panneau de Configuration (Bas à Gauche)} : Permet de configurer le graphique (type, données, apparence)
    
    \item \textbf{Zone de Rendu (Centre Gauche)} : Affiche le graphique généré en temps réel
...
\begin{itemize}
    \item \textbf{Fichier} : Gestion des fichiers (Ouvrir, Ouvrir fichier récent, Ouvrir URL)
    \item \textbf{Aide} : Aide et paramètres (Langues, documentation, à propos)
\end{itemize}

\section{Chargement des Données}

\subsection{Importer un Fichier}
Pour charger un fichier :

\begin{enumerate}
    \item Cliquez sur \textbf{Fichier} → \textbf{Ouvrir}
...
Pangol1 accepte les fichiers au format \textbf{( CSV , txt, TSV, ZIP, Parquet )} (Comma-Separated Values) :
...
\begin{enumerate}
    \item Cliquez sur \textbf{Aide} → \textbf{Langues}
...
\begin{itemize}
    ...
    \item \textbf{En-têtes de Colonnes} : Cliquez ( clic Droit ) sur les en-têtes pour accéder aux options de tri et filtrage
...
\begin{enumerate}
    \item Cliquez droit sur l'en-tête de la colonne
...
Pour masquer ou renommer une colonne :

\begin{enumerate}
    \item Cliquez droit sur l'en-tête de la colonne
    \item Sélectionnez \textbf{Masquer}
    \item La colonne disparaît de la table
    \item Ou sélectionnez \textbf{renommer}
    \item Pour renommer la colonne comme bon vous souhaite
\end{enumerate}

\subsection{Statistique}
Pour avoir des statistique sur la colonne :

\begin{enumerate}
    \item Cliquez droit sur l'en-tête de la colonne
    \item Sélectionnez \textbf{Statistiques}
    \item Puis \textbf{Résumé} pour avoir : ( Min, Max, Moyenne, Somme,le nombre de données, le nombre de cellule vide, le type)
    \item Ou \textbf{Taux de valeur nulles} pour avoir les valeurs nouvelles
    \item Ou \textbf{Taux de cardinalités} pour avoir les cardinalités
\end{enumerate}
