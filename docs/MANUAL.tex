...
\begin{itemize}
  ...
  \item \textbf{S\'el\'eection de colonnes} : Permet de s\'el\'eectionner une colonne et d'afficher ses statisitques de base (moyenne, m\'ediane, \`ecart-type, etc.) dans la barre d'information en bas de l'interface.
\end{itemize}
