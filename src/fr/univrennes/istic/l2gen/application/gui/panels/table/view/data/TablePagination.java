...
public final class TablePagination extends JPanel {
    ...
    public TablePagination(TableModel tableModel) {
        ...
        firstPageButton = new JButton(Lang.get("table.pagination.first"));
        firstPageButton.addActionListener(e -> {
            tableModel.goToPage(0);
            refresh();
        });

        previousPageButton = new JButton(Lang.get("table.pagination.previous"));
        ...
        nextPageButton = new JButton(Lang.get("table.pagination.next"));
        nextPageButton.addActionListener(e -> {
            tableModel.nextPage();
            refresh();
        });

        lastPageButton = new JButton(Lang.get("table.pagination.last"));
        ...
        for (int i = 0; i < PAGE_SIZE_OPTIONS.length; i++) {
            pageSizeLabels[i] = Lang.get("table.pagination.page_size", PAGE_SIZE_OPTIONS[i]);
        }
    ...
    public void refresh() {
        ...
        pageInfoLabel.setText(Lang.get("table.pagination.page_info", currentPage, totalPages));
