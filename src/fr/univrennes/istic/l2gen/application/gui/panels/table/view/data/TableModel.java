...
public final class TableModel extends AbstractTableModel {
    ...
    public int getRowNumberAt(int rowIndex) {
        return getPageStartRow() + rowIndex + 1;
    }
    ...
    public void setValueAt(Object value, int rowIndex, int columnIndex) {
        ...
        String taskId = GUIController.getInstance().addTask(Lang.get("task.table.write"), TaskStatus.PENDING);
        new SwingWorker<Boolean, Void>() {
            @Override
            protected Boolean doInBackground() throws Exception {
                return table.setValueAt(getPageStartRow() + rowIndex, columnIndex, value);
            }
