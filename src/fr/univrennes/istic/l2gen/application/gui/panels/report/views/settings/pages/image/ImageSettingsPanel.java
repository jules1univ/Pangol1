...
public final class ImageSettingsPanel extends SettingSectionPanel implements IReportSettingPanel {
    ...
    public ImageSettingsPanel() {
        super(Lang.get("report.settings.image"));

        JButton selectBtn = new JButton(Lang.get("report.settings.image.select"));
        selectBtn.addActionListener(e -> {
            ...
            fileChooser.addChoosableFileFilter(new SystemFileChooser.FileNameExtensionFilter(
                    Lang.get("report.settings.image"),
        ...
        addRow(new SettingRowPanel(Lang.get("report.settings.image.path"), controlPanel));
    }
