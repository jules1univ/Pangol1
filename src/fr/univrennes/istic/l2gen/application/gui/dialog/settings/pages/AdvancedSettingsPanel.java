...
public final class AdvancedSettingsPanel extends AbstractSettingsPanel {
        ...
        public AdvancedSettingsPanel() {
                ...
                performanceSection.addRow(
                                new SettingsRowPanel(Lang.get("settings.advanced.performance.max_undo_steps"),
                                                maxUndoStepsSpinner));
                performanceSection
                                .addRow(new SettingsRowPanel(Lang.get("settings.advanced.performance.max_rows_memory"),
                                                maxRowsInMemorySpinner));
                performanceSection.addRow(
                                new SettingsRowPanel(Lang.get("settings.advanced.performance.virtual_scrolling"),
                                                enableVirtualScrollingCheckBox));
                performanceSection.addRow(
                                new SettingsRowPanel(Lang.get("settings.advanced.performance.background_threads"),
                                                backgroundThreadsSpinner));

                SettingsSectionPanel loggingSection = new SettingsSectionPanel(
                                Lang.get("settings.advanced.section.logging"));
                loggingSection.addRow(
                                new SettingsRowPanel(Lang.get("settings.advanced.logging.level"), logLevelComboBox));
                loggingSection
                                .addRow(new SettingsRowPanel(Lang.get("settings.advanced.logging.write_file"),
                ...
                developerSection.addRow(
                                new SettingsRowPanel(Lang.get("settings.advanced.developer.show_internal_errors"),
                                                showInternalErrorsCheckBox));
                developerSection.addRow(
                                new SettingsRowPanel(Lang.get("settings.advanced.developer.experimental_features"),
