...
public final class AppearanceSettingsPanel extends AbstractSettingsPanel {
    ...
    public AppearanceSettingsPanel() {
        ...
        SettingsSectionPanel themeSection = new SettingsSectionPanel(Lang.get("settings.appearance.section.theme"));
        themeSection.addRow(new SettingsRowPanel(Lang.get("settings.appearance.theme"), themeComboBox));
        themeSection.addRow(new SettingsRowPanel(Lang.get("settings.appearance.accent_color"), accentColorComboBox));

        SettingsSectionPanel fontSection = new SettingsSectionPanel(Lang.get("settings.appearance.section.font"));
        fontSection.addRow(new SettingsRowPanel(Lang.get("settings.appearance.font.family"), fontFamilyComboBox));
        fontSection.addRow(new SettingsRowPanel(Lang.get("settings.appearance.font.size"), fontSizeSpinner));

        SettingsSectionPanel tableSection = new SettingsSectionPanel(Lang.get("settings.appearance.section.table"));
        tableSection
                .addRow(new SettingsRowPanel(Lang.get("settings.appearance.table.show_grid"), showGridLinesCheckBox));
        tableSection.addRow(
                new SettingsRowPanel(Lang.get("settings.appearance.table.alternate_rows"), alternateRowColorsCheckBox));
        tableSection.addRow(new SettingsRowPanel(Lang.get("settings.appearance.table.row_height"), rowHeightSpinner));

        SettingsSectionPanel uiSection = new SettingsSectionPanel(Lang.get("settings.appearance.section.ui"));
        uiSection.addRow(
                new SettingsRowPanel(Lang.get("settings.appearance.ui.show_status_bar"), showStatusBarCheckBox));
        uiSection.addRow(
                new SettingsRowPanel(Lang.get("settings.appearance.ui.show_column_stats"), showColumnStatsCheckBox));
