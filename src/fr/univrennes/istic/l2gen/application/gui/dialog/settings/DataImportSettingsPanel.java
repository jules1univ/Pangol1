...
public final class DataImportSettingsPanel extends AbstractSettingsPanel {
    ...
    public DataImportSettingsPanel() {
        ...
        encodingSection.addRow(
                new SettingsRowPanel(Lang.get("settings.data_import.encoding.default"), defaultEncodingComboBox));
        ...
        delimiterSection.addRow(
                new SettingsRowPanel(Lang.get("settings.data_import.delimiter.default"), defaultDelimiterComboBox));
        delimiterSection
                .addRow(new SettingsRowPanel(Lang.get("settings.data_import.delimiter.custom"), customDelimiterField));
        delimiterSection
                .addRow(new SettingsRowPanel(Lang.get("settings.data_import.delimiter.quote_char"), quoteCharComboBox));
        ...
        parsingSection.addRow(
                new SettingsRowPanel(Lang.get("settings.data_import.parsing.trim_whitespace"), trimWhitespaceCheckBox));
        parsingSection.addRow(new SettingsRowPanel(Lang.get("settings.data_import.parsing.skip_empty_lines"),
                skipEmptyLinesCheckBox));
        parsingSection.addRow(
                new SettingsRowPanel(Lang.get("settings.data_import.parsing.preview_rows"), previewRowCountSpinner));
        ...
        typeInferenceSection
                .addRow(new SettingsRowPanel(Lang.get("settings.data_import.types.infer"), inferTypesCheckBox));
        typeInferenceSection
                .addRow(new SettingsRowPanel(Lang.get("settings.data_import.types.parse_dates"), parseDatesCheckBox));
        typeInferenceSection
                .addRow(new SettingsRowPanel(Lang.get("settings.data_import.types.date_format"), dateFormatField));
