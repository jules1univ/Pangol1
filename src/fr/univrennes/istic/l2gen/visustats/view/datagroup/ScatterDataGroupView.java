...
@SVGTag("g")
public final class ScatterDataGroupView extends AbstractDataGroupView {
    ...
    public ScatterDataGroupView(DataGroup data, Point center, double spacing, double pointSpacing, double maxHeight,
    ...
    protected IDataSetView createElement(Point position) {
        return new ScatterDataSetView(position, this.pointSpacing, this.maxHeight, this.pointRadius);
    }
